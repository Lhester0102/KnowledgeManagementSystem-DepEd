...
Public Class rooms_ni
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For a = Val(TextBox3.Text) To DataGridView1.Rows.Count - 2
            ...
            Try
                conn.Open()
                query = "INSERT INTO `depedkms`.`rooms_ni` (`school_id`, `school_name`, `region`, `province`, `municipality`, `division`, `district`, `libraries`, `clinic`, `canteen`, `offices`, `not_currently_used`, `total_non_instructional_room`, `school_year`, `school_type`) VALUES ('" & strData(0) & "', '" & strData(1) & "', '" & strData(2) & "', '" & strData(3) & "', '" & strData(4) & "', '" & strData(5) & "', '" & strData(6) & "', '" & strData(7) & "', '" & strData(8) & "', '" & strData(9) & "', '" & strData(10) & "', '" & strData(11) & "', '" & strData(12) & "', '" & TextBox1.Text & "', '" & ComboBox3.Text & "')"
