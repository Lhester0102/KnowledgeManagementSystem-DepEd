...
Public Class teachers
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For a = Val(TextBox3.Text) To DataGridView1.Rows.Count - 2
            ...
            strData(14) = Val(strData(7)) + Val(strData(8)) + Val(strData(9)) + Val(strData(10)) + Val(strData(11)) + Val(strData(12)) + Val(strData(13))
            Try
                conn.Open()
                query = "INSERT INTO `depedkms`.`teachers` (`school_id`, `school_name`, `region`, `province`, `municipality`, `division`, `district`, instructor,mobile_teacher3,mobile_teacher2,mobile_teacher1,`teacher3`, `teacher2`, `teacher1`, `total_teacher`, school_year,`school_type`) VALUES ('" & strData(0) & "', '" & strData(1) & "', '" & strData(2) & "', '" & strData(3) & "', '" & strData(4) & "', '" & strData(5) & "', '" & strData(6) & "','" & strData(7) & "','" & strData(8) & "','" & strData(9) & "','" & strData(10) & "', '" & strData(11) & "', '" & strData(12) & "', '" & strData(13) & "', '" & strData(14) & "', '" & TextBox1.Text & "','" & ComboBox3.Text & "')"
