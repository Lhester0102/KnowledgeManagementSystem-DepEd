...
Public Class s_electricity
    ...
    Private Sub s_electricity_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub regional_SelectedIndexChanged(sender As Object, e As EventArgs) Handles regional.SelectedIndexChanged
        ...
        conn.ConnectionString = strcon
        Try
            query = "SELECT distinct province from electricity where school_type='ELEMENTARY' and region='" & regional.Text & "' order by province"
            conn.Open()
            com = New MySqlCommand(query, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Private Sub province_SelectedIndexChanged(sender As Object, e As EventArgs) Handles province.SelectedIndexChanged
        ...
        conn.ConnectionString = strcon
        Try
            query = "SELECT distinct division from electricity where school_type='ELEMENTARY' and region='" & regional.Text & "' and province='" & province.Text & "' order by division"
            conn.Open()
            com = New MySqlCommand(query, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Private Sub division_SelectedIndexChanged(sender As Object, e As EventArgs) Handles division.SelectedIndexChanged
        ...
        conn.ConnectionString = strcon
        Try
            query = "SELECT distinct district from electricity where school_type='ELEMENTARY' and region='" & regional.Text & "' and province='" & province.Text & "'  and division='" & division.Text & "' order by district"
            conn.Open()
            com = New MySqlCommand(query, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Private Sub district_SelectedIndexChanged(sender As Object, e As EventArgs) Handles district.SelectedIndexChanged
        ...
        conn.ConnectionString = strcon
        Try
            query = "SELECT distinct municipality from electricity where school_type='ELEMENTARY' and region='" & regional.Text & "' and province='" & province.Text & "'  and division='" & division.Text & "' and district='" & district.Text & "' order by municipality"
            conn.Open()
            com = New MySqlCommand(query, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Private Sub municipality_SelectedIndexChanged(sender As Object, e As EventArgs) Handles municipality.SelectedIndexChanged
        ...
        conn.ConnectionString = strcon
        Try
            query = "SELECT distinct school_name from electricity where school_type='ELEMENTARY' and region='" & regional.Text & "' and province='" & province.Text & "'  and division='" & division.Text & "' and district='" & district.Text & "' and municipality='" & municipality.Text & "' order by school_name"
            conn.Open()
            com = New MySqlCommand(query, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Sub loadschool_name_es()
        ...
        conn.ConnectionString = strcon
        Try
            squery = "SELECT school_name,region,province,division,district,municipality,sum(solar_power) as 'solar',sum(generator) as 'gen',sum(grid_supply) as 'grid', school_year FROM depedkms.electricity where school_type='ELEMENTARY' and  municipality like'%" & municipality.Text & "%' and  district like'%" & district.Text & "%' and  division like'%" & division.Text & "%' and  province like'%" & province.Text & "%' and   region like'%" & regional.Text & "%'  group by school_name,school_year order by school_name,school_year"
            conn.Open()
    ...
    Sub loadschool_sname_es()
        ...
        conn.ConnectionString = strcon
        Try
            squery = "SELECT school_name,region,province,division,district,municipality,sum(solar_power) as 'solar',sum(generator) as 'gen',sum(solar_power) as 'solar',sum(generator) as 'gen',sum(grid_supply) as 'grid', school_year FROM depedkms.electricity where school_type='ELEMENTARY' and  school_name like'%" & sname.Text & "%' and  municipality like'%" & municipality.Text & "%' and  district like'%" & district.Text & "%' and  division like'%" & division.Text & "%' and  province like'%" & province.Text & "%' and   region like'%" & regional.Text & "%'  group by school_name,school_year order by school_name,school_year "
            conn.Open()
            com = New MySqlCommand(squery, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Sub loadschool_municipality_es()
        ...
        conn.ConnectionString = strcon
        Try
            squery = "SELECT school_name,region,province,division,district,municipality,sum(solar_power) as 'solar',sum(generator) as 'gen',sum(grid_supply) as 'grid', school_year FROM depedkms.electricity where school_type='ELEMENTARY' and    division like'%" & division.Text & "%' and  province like'%" & province.Text & "%' and   region like'%" & regional.Text & "%'  group by municipality,school_year order by municipality,school_year "
            conn.Open()
            com = New MySqlCommand(squery, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Sub loadschool_division_es()
        ...
        conn.ConnectionString = strcon
        Try
            squery = "SELECT school_name,region,province,division,district,municipality,sum(solar_power) as 'solar',sum(generator) as 'gen',sum(grid_supply) as 'grid', school_year FROM depedkms.electricity where school_type='ELEMENTARY' and  province like'%" & province.Text & "%' and   region like'%" & regional.Text & "%'  group by division,school_year order by division,school_year "
            conn.Open()
            com = New MySqlCommand(squery, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Sub loadschool_province_es()
        ...
        conn.ConnectionString = strcon
        Try
            squery = "SELECT school_name,region,province,division,district,municipality,sum(solar_power) as 'solar',sum(generator) as 'gen',sum(grid_supply) as 'grid', school_year FROM depedkms.electricity where school_type='ELEMENTARY' and   region='" & regional.Text & "'  group by province,school_year order by province,school_year"
            conn.Open()
            com = New MySqlCommand(squery, conn)
            READER = com.ExecuteReader
            While READER.Read
    ...
    Sub loadschool_region_es()
        ...
        conn.ConnectionString = strcon
        Try
            squery = "SELECT school_name,region,province,division,district,municipality,sum(solar_power) as 'solar',sum(generator) as 'gen',sum(grid_supply) as 'grid', school_year FROM depedkms.electricity where school_type='ELEMENTARY' group by region,school_year order by region,school_year "
            conn.Open()
            com = New MySqlCommand(squery, conn)
            READER = com.ExecuteReader
            While READER.Read
